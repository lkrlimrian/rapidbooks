        ...
        <div class="card-body">
            <div class="col-md-12 font14">
                <div class="col-md-6 p-2">
                    <h5 class="text-info"><a href="chartOfAccounts.php">Chart of Accounts</a></h5>
                ...
                <div class="col-md-6 p-2">
                    <h5 class="text-info"><a href="paymentMethods.php">Payment Methods</a></h5>
                ...
                <div class="col-md-6 p-2">
                    <h5 class="text-info"><a href="recurringTransactions.php">Recurring Transactions</a></h5>
                ...
                <div class="col-md-6 p-2">
                    <h5 class="text-info"><a href="terms.php">Terms</a></h5>
                ...
                <div class="col-md-6 p-2">
                    <h5 class="text-info"><a href="productsAndServices.php">Products and Services</a></h5>
                ...
                <div class="col-md-6 p-2">
                    <h5 class="text-info"><a href="attachments.php">Attachments</a></h5>
                ...
                <div class="col-md-6 p-2">
                    <h5 class="text-info"><a href="productCategories.php">Product Categories</a></h5>
                ...
                <div class="col-md-6 p-2">
                    <h5 class="text-info"><a href="customFormStyles.php">Custom Form Styles</a></h5>
